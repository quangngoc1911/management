...
public class DocumentService : ManagementSystem.Interfaces.IDocumentService
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IFileStorageService _fileStorageService;

    public DocumentService(IUnitOfWork unitOfWork, IFileStorageService fileStorageService)
    {
